...
class EditTaskScreen extends StatefulWidget {
  ...
  const EditTaskScreen({super.key, this.arguments});
...
class _EditTaskScreenState extends State<EditTaskScreen> {
  ...
  void initState() {
    ...
    if (widget.arguments != null && widget.arguments is int) {
      final task = TaskService.findTaskDetail(widget.arguments);

      titleController.text = task["title"];
      descController.text = task["description"];

      endDate = DateTime.parse(task["due_date"]);
  ...
  void updateTask() async {
    ...
    Map<String, dynamic> result = await TaskService.updateTask(task!["id"], {
